...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10">
        <h2>Collaborator Listing</h2>
        <ol class="breadcrumb">
            <li>
                <a href="{{ URL::to('/') }}/admin/dashboard">Home</a>
            </li>
            <li class="active">
                <strong>Collaborator Listing</strong>
            </li>            
        </ol>
    </div>
    <div class="col-lg-2">
                      ...
                      <table class="table table-striped">
                          ...
                          @foreach($collaborator_listing as $key => $value)
                            ...
                            <tr>                            
                              ...
                              <td> 
                                <a class="btn btn-primary m-r-sm" href="{{URL::to('/')}}/admin/collaborator-details/{{$value->id}}" role="button">Details</a> 
                              </td>
                            </tr>  
  ...
  <div class="row">    
    <div class="col-sm-12">
      <div class="dataTables_paginate paging_simple_numbers pull-right" id="editable_paginate">
        <ul class="pagination">
          @if($collaborator_listing[0]->page_no == 0)
          ...
          @else
            <li class="paginate_button previous" id="editable_previous">
              <a href="{{ URL::to('/') }}/admin/collaborator-listing/{{ $collaborator_listing[0]->keyword }}/{{ $collaborator_listing[0]->page_no - 1 }}" aria-controls="editable" data-dt-idx="0" tabindex="0">Previous</a>
            </li>
          @endif          
          @for($i=0; $i<$collaborator_listing[0]->total_pages; $i++) 
            <li class="paginate_button active">
              <a href="{{ URL::to('/') }}/admin/collaborator-listing/{{ $collaborator_listing[0]->keyword }}/{{ $i }}" aria-controls="editable" data-dt-idx="1" tabindex="0"> {{ $i+1 }} </a>
            </li>
          @endfor     
          @if($collaborator_listing[0]->page_no == $collaborator_listing[0]->total_pages - 1)
          ...
          @else
            <li class="paginate_button next" id="editable_next">
              <a href="{{ URL::to('/') }}/admin/collaborator-listing/{{ $collaborator_listing[0]->keyword }}/{{ $collaborator_listing[0]->page_no + 1 }}" aria-controls="editable" data-dt-idx="7" tabindex="0">Next</a>
            </li>
          @endif                
        </ul>
      </div>
